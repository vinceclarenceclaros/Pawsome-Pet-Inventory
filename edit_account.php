  ...
  <div class="col-md-6">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-md-4">
              <img class="img-circle img-size-2" src="uploads/users/<?php echo $user['image'];?>" alt="" style="border: 2px solid #ccc;">
            </div>
            <div class="col-md-8">
              <form class="form" action="edit_account.php" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                  <label class="btn btn-primary" for="file-upload">Choose File</label>
                  <input id="file-upload" type="file" name="file_upload" multiple="multiple" style="display: none;" />
              </div>
              <div class="form-group">
